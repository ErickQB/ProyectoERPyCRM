...
namespace ProyectoX.Controllers
{
    ...
    public class BodegasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdBodega,Nombre,Codigo,Ubicacion,Capacidad,Estado,FechaCreacion,FechaActualizacion")] Bodega bodega)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdBodega,Nombre,Codigo,Ubicacion,Capacidad,Estado,FechaCreacion,FechaActualizacion")] Bodega bodega)
        {
