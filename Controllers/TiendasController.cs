...
namespace ProyectoX.Controllers
{
    ...
    public class TiendasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdTienda,Codigo,Nombre,Direccion,RazonSocial,Telefono,CorreoElectronico,Estado,FechaCreacion,FechaActualizacion")] Tienda tienda)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdTienda,Codigo,Nombre,Direccion,RazonSocial,Telefono,CorreoElectronico,Estado,FechaCreacion,FechaActualizacion")] Tienda tienda)
        {
